...
<div class="navbar">
	...
	<form action="allscooters">
		<div class="row row-cols-3 g-3">
		<div class="col">
				<div class="card">
				<img alt="card1" width="" height="" src="resources/images/scootycard1.jpg">
					<div class="card-body">
						<button><a href="scooter1">scooter</a></button>	
						<p class="text-secondary" class="card-text">Solimo Honda CB Shine Water Resistant Bike Cover (Silver) | Cover for Bike</p>
					</div>
				</div>
			</div>
			...
			<div class="col">
				<div class="card">
					<img alt="card1" width="" height="" src="resources/images/scootycard1.jpg">
					<div class="card-body">
						<button><a href="scooter2">scooter</a></button>	
						<p class="text-secondary" class="card-text">Solimo Honda CB Shine Water Resistant Bike Cover (Silver) | Cover for Bike</p>
					</div>
				</div>
			</div>
			...
			<div class="col">
				...
				<img alt="card1" width="" height="" src="resources/images/scootycard1.jpg">
					<div class="card-body">
						<button><a href="scooter3">scooter</a></button>	
						<p class="text-secondary" class="card-text">Solimo Honda CB Shine Water Resistant Bike Cover (Silver) | Cover for Bike</p>
					</div>
				</div>
			</div>
