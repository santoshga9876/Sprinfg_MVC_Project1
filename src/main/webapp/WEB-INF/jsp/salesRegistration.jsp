			...
			<div class="col-lg-8 col-xl-6">
				<div class="card rounded-3">
					...
					<div class="card-body p-4 p-md-5">
						...
						<form action="salesRegister" method="post" class="px-md-2">

							<div class="form-outline mb-4">
								<input type="text" name="customername" id="form3Example1q"
									class="form-control" /> <label class="form-label"
									for="form3Example1q">Customer Name</label>
							</div>

							<div class="form-outline mb-4">
								<input type="text" name="customerMobilenNo" id="form3Example1q"
									class="form-control" /> <label class="form-label"
									for="form3Example1q">Customer Mobile No</label>
							</div>

							<div class="form-outline mb-4">
								<input type="text" name="customerAddress" id="form3Example1q"
									class="form-control" /> <label class="form-label"
									for="form3Example1q">Customer Address</label>
							</div>

							<div class="form-outline mb-4">
								<input type="email" name="customeremail" id="form3Example1q"
									class="form-control" /> <label class="form-label"
									for="form3Example1q">Customer Email</label>
							</div>

							<div class="form-outline mb-4">
								<input type="date" name="customerDob" id="form3Example1q"
									class="form-control" /> <label class="form-label"
									for="form3Example1q">Sales date</label>
							</div>


							<div class="form-outline mb-4">
								<input type="text" name="customerIdproof" id="form3Example1q"
									class="form-control" /> <label class="form-label"
									for="form3Example1q">Customer Id Proof</label>
							</div>

							<div class="form-outline mb-4">
								<div class="form-group">
									<select type="text" name="customerGender" class="form-control"
							...
							<div class="form-outline mb-4">
								<div class="form-group">
									<select type="text" name="customerState" class="form-control"
										id="exampleFormControlSelect1">
							...
							<label style="font-weight: bold;" for="exampleFormControlSelect1"> Bike Information</label>
                            <div class="form-outline mb-4">
								<div class="form-group">
									<select type="text" name="bikname" class="form-control"
										id="exampleFormControlSelect1">
										<option value="Gender" disabled>Select Bike Type</option>
										<option value="Scooter">Scooter</option>
										<option value="Bike">Bike</option>
									
									</select> <label for="exampleFormControlSelect1"> select Bike</label>
								</div>
							</div>
                            
							<div class="form-outline mb-4">
								<input type="text" name="bikmodal" id="form3Example1q"
									class="form-control" /> <label class="form-label"
									for="form3Example1q">Bike Modal</label>
							</div>
							
							<div class="form-outline mb-4">
								<input type="text" name="bikquantity" id="form3Example1q"
									class="form-control" /> <label class="form-label"
									for="form3Example1q">Bike Quantity </label>
							</div>
							

							<div class="form-outline mb-4">
								<input type="text" name="bikprice" id="form3Example1q"
									class="form-control" /> <label class="form-label"
									for="form3Example1q">Price </label>
							</div>
