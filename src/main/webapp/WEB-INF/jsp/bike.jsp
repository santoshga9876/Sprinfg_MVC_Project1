...
<div class="navbar">
	...
	<form action="allbikeform" method="post">

		<div class="row row-cols-3 g-3">
			<div class="col">
				<div class="card">
				<img alt="card1" width="" height="" src="resources/images/chard1.jpg">
					<div class="card-body">
					<button><a href="bike1">shine</a></button>	

						<p class="text-light bg-dark" class="card-text"> Solimo Honda CB Shine Water Resistant Bike Cover (Silver) | Cover for Bike</p>
					</div>
				</div>
			</div>
				...
				<div class="col">
				<div class="card">
	 			<img alt="card1" width="" height="" src="resources/images/bikecard.jpg">
					<div class="card-body">
					<button><a href="bike2">shine</a></button>	
				...
				<img alt="card1" width="" height="" src="resources/images/chard1.jpg"> 
					<div class="card-body">
					<button><a href="bike3">shine</a></button>	
				...
				<div class="card">
						<img alt="card1" width="" height="" src="resources/images/chard1.jpg">
					<div class="card-body">
					<button><a href="bike4">shine</a></button>	
