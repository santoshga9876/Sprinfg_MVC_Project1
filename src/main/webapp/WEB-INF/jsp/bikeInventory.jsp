			...
			<div class="col-lg-8 col-xl-6">
				<div class="card rounded-3">
					...
					<div class="card-body p-4 p-md-5">
						<h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">Bike Inventory</h3>

						<form action="bikinventory" method="post" class="px-md-2">

							<div class="form-outline mb-4">
								<input type="text" name="bikname" id="form3Example1q"
									class="form-control" /> <label class="form-label"
									for="form3Example1q">Bike Name </label>
							</div>
							...
							<div class="form-outline mb-4">
								<input type="date" name="mnfdate" id="form3Example1q"
									class="form-control" /> <label class="form-label"
									for="form3Example1q"> Manufacturer Date </label>
							</div>

							<div class="form-outline mb-4">
								<input type="text" name="bikcolor" id="form3Example1q"
									class="form-control" /> <label class="form-label"
									for="form3Example1q">Bike Color</label>
							</div>
							...
							<div class="form-outline mb-4">
								<input type="date" name="bikarrivekdate" id="form3Example1q"
									class="form-control" /> <label class="form-label"
									for="form3Example1q"> Arrival Date </label>
							</div>
