	...
	<table class="table">
		...
		<c:forEach var="empdata" items="${empList}">
			<tr>
				...
				<td>
				<a href="deleteEmployee?id=${empdata.id}"><i class="material-icons">delete</i> </a>
				<a href="updateForm ?id=${empdata.id}&fname=${empdata.fname}&lname=${empdata.lname }
				&dob=${empdata.dob }&gender=${empdata.gender }&state=${empdata.state }
				&date=${empdata.date }&password=${empdata.password }"><i class="material-icons">edit</i>	</a>
				</td>
			</tr>
		</c:forEach>
	</table>
